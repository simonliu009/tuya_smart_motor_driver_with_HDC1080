...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C4_MspInit 0 */
    ...
    */
    ...
    HAL_GPIO_WritePin(GPIOH, 11, GPIO_PIN_SET); // 拉高 SCL
    HAL_GPIO_WritePin(GPIOH, 12, GPIO_PIN_SET); // 拉高 SDA
    i2cHandle->Instance->CR1= 1; // 复位 I2C 控制器
    i2cHandle->Instance->CR1= 0; // 解除复位（不会自动清除）

//
//    GPIO_InitStruct.Pin = GPIO_PIN_11|GPIO_PIN_12; // 此行原有
//    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP; //GPIO 配置为输出
