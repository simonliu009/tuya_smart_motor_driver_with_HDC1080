...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "aaaaaaaaaaaaaaaa"    //开发平台创建产品后生成的16位字符产品唯一标识
...
#define WIFI_DATA_PROCESS_LMT           512              //串口数据处理缓存区大小,根据用户DP数据大小量定,必须大于24
#else
#define WIFI_UART_RECV_BUF_LMT          512             //串口数据接收缓存区大小,如MCU的RAM不够,可缩小
...
//全程运行时间(只上报)
//备注:
#define DPID_TIME_TOTAL 13
//工作模式(可下发可上报)
//备注:
#define DPID_WORK_MODE 17
//门窗开关(可下发可上报)
//备注:
#define DPID_SWITCH_DOOR_WIN 20
//天气(只上报)
//备注:
#define DPID_SMART_WEATHER 21
//风速状态(只上报)
//备注:
#define DPID_WIND_SPEED_STATE 22
//当前温度(只上报)
//备注:
#define DPID_TEMP_CURRENT 23
//风光雨传感器开关(可下发可上报)
//备注:
#define DPID_SWITCH_SENSOR 24
//相对湿度(只上报)
//备注:
#define DPID_HUMUDITY 101
