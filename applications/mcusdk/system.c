...
//        while (k <= data_len)
//        {
//            rt_kprintf("%02X ",p_data[k]);
//            k++;
//        }
//        rt_kprintf("\r\n p_data[%d] in char:",data_len);
//        k = 0;
//        while (k <= data_len)
//        {
//            rt_kprintf("%c",p_data[k]);
//            k++;
//       }
//        rt_kprintf("\r\n");
...
//            my_memcpy(can, p_data + i + 1, can_len);
            ...
            if (type1 == 0) { //int32
                ...
                //For debug only
//                rt_kprintf("process weather :%s, type:%d , data:%d \r\n", can, type1,*(p_data+val_cnt+1));
//                int j = 0;
//                rt_kprintf("can[15]:");
//                rt_kprintf("\r\n");
//                while (j < 15)
...
//                rt_kprintf("process weather string type");
            }
